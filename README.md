...
### DESCRIPTION: 
### To add a more professional website style, we added a login/signup page that opens when the user clicks the personality quiz webpage. Without logging in, the user cannot save his/her data, nor can he/she open the quiz. This allows multiple users to use the personality quiz without having to tamper on the previous user's results. This update for our 2nd Quarter Website Project introduces a more interactive kind of webpage that lets the user fill in personal information related to personality and character-like traits. The first webpage gives prompts that the user answers on how much they agree or disagree. After answering, the user has the freedom to look at which Greek god/hero (one webpage for the similar god and one webpage for similar hero) is closest to him/her in terms of personality and traits. The user also has the freedom to choose whether to save the data of the quiz or not.
...
### WIREFRAMES: 
#### Sign-up Page: 
#### ![signup](assets/wireframeimgs/signup.png)
#### Login Page:
#### ![login](assets/wireframeimgs/login.png)
#### Personality Quiz: 
#### ![profile_quiz](assets/wireframeimgs/profilequiz.png)
#### Certificate/Link:
#### ![certificate](assets/wireframeimgs/certificate1.png) 
#### Certificate/Link Expanded:
#### ![certificate_expanded](assets/wireframeimgs/certificate_expanded.png)
#### God Profile: 
